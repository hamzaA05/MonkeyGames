...
class Ghost {
    ...
    draw() {
        ...
        c.fillStyle = this.scared ? 'yellow' : this.color
        c.fill()
        c.closePath()
    }
...
function animate() {
    ...
    // GHOST, PELLETS AND POWERUPS SECTION

    //---final ghost to player contact
